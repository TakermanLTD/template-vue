...
COPY . .
COPY ["takerman.template.client/nuget.config", "./"]
COPY ["takerman.template.client/package.json", "package.json"]
...
WORKDIR "/src/Takerman.Template.Server"
...
ENTRYPOINT ["dotnet", "Takerman.Template.Server.dll"]